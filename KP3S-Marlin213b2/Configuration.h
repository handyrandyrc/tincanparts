...
#define STRING_CONFIG_H_AUTHOR "(Randy)" // Original author or contributor.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 113.94
  #define DEFAULT_bedKi  20.35
  #define DEFAULT_bedKd 425.37
